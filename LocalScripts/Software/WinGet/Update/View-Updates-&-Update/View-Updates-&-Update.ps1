...
Write-Host "The .log file time apear to be GMT -7"

Get-ChildItem "C:\Users\$env:UserName\AppData\Local\Packages\Microsoft.DesktopAppInstaller_8wekyb3d8bbwe\LocalState\DiagOutputDir"

$Log = Read-Host "Please copy and paste the specific .log name you wish to view"

Get-Content -Path "C:\Users\$env:UserName\AppData\Local\Packages\Microsoft.DesktopAppInstaller_8wekyb3d8bbwe\LocalState\DiagOutputDir/$Log"
