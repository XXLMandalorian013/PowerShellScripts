#ReadMe
<#
Cloud-Contact-Center-AccentDesktop-64Bit-2.0.1.ps1
...
function Start-ScriptBoilerPlate {
    ...
    param (
        #Script Name
        $ScriptName = 'Cloud-Contact-Center-AccentDesktop-64Bit-2.0.1.ps1',
        #Script Author
...
function Install-AccentDesktop {
    param(
        ...
        $InstallerName = 'Accent+2.0.1.msi',
        #Out-File location.
