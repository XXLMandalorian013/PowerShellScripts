...
Gets Bitlocker KeyProtectorType, KeyProtectorId, and RecoveryPassword.
...
function Start-ScriptBoilerplate {
    $ScriptName = "Get-BitLockerRecoveryPassword.ps1"
...
function Get-BitLockerRecoveryPassword {
    ...
    #Verbosly states what computer it is grabbing the BL key for.
    Write-Verbose -Message "Computer = $env:computername" -Verbose
    #Gets Bitlocker KeyProtectorType, KeyProtectorId, and RecoveryPassword.
