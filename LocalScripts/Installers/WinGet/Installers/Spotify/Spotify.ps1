...
Write-Error "This script requires NON-Administrator rights. To run this cmdlet, start PowerShell with the `"Run as administrator`" option."
    return
...
winget install --id Spotify.Spotify --accept-source-agreements --Scope Machine
