...
#Make sure to add a -file and a single space fallowed by the file path since this is for PS 5.1. '-file "\\Server\Folder\Automated-Restore-Point.ps1"'
$TSActions = New-ScheduledTaskAction -Execute "powershell.exe" -Argument '-file "\\Server\Folder\Auto-Resto-Point-Check.ps1"'
...
$TSTriggers = New-ScheduledTaskTrigger -Weekly -WeeksInterval 1 -DaysOfWeek thursday -At 11pm
